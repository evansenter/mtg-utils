...
Split from a single module by the QUESTION each printer answers:
    ...
    deck.py   what is in the 100 -- skeleton, roster, combos, primer
...
from mtg_utils.report.deck import (report_combos, report_primer, report_roster,
                                   report_skeleton)
...
__all__ = ["report_calibrate", "report_ceiling", "report_combos",
           "report_contention", "report_diff", "report_mana", "report_own",
           "report_primer", "report_roster", "report_skeleton", "report_swap",
           "report_variants"]
